...
"""
function area_polygon(vertices::Polygon)
    abs(first_moment(vertices))
end

function first_moment(vertices::Polygon)
...
is_clockwise(vertices::Polygon) = first_moment(vertices) <= 0.0
is_counter_clockwise(vertices::Polygon) = first_moment(vertices) > 0.0
...
"""
function centroid_polygon(vertices::Polygon)
