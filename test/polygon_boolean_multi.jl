...
@testset verbose=true "self-intersecting star" begin
    ...
    regions = union_geometry(alg, self_intersect_star)
    @test are_regions_equal(regions, expected)
end
...
@testset verbose=true "cross + triangle" begin
    ...
    @testset "difference" begin
        ...
        regions2 = difference_geometry(alg, regions[1:1], regions[2], triangle) # top region is no longer primary
    ...
    @testset "xor" begin
        expected = [
            # exterior
            [(1.0, 0.0), (1.0, 0.5), (2.0, 0.5), (2.0, 1.5), (1.214286, 1.5), (1.5, 2.0), (1.0, 1.875), (1.0, 2.0), (0.0, 2.0), (0.0, 1.625), (-0.5, 1.5), (-1.0, 1.5), (-1.0, 0.5), (0.0, 0.5), (0.0, 0.0)],
            # holes
            [(-0.5, 1.5), (0.0, 1.5), (0.0, 0.875)],
            [(1.0, 1.5), (0.0, 1.5), (0.0, 1.625), (1.0, 1.875)],
            [(0.3, 0.5), (0.642857, 0.5), (0.5, 0.25)],
            [(0.0, 0.5), (0.0, 0.875), (0.3, 0.5)],
            [(0.642857, 0.5), (1.0, 1.125), (1.0, 0.5)],
            [(1.214286, 1.5), (1.0, 1.125), (1.0, 1.5)],
        ]
...
@testset verbose=true "appearing holes" begin
    ...
    @testset "xor" begin
        expected = [
            ...
            # holes
            [(1.0, -0.0), (1.323077, 0.0), (1.0, -0.494118)],
