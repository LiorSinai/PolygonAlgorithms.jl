...
The philosophy of this package is to define an absolute tolerance `atol` that can be passed down as a keyword argument throughout the entire algorithm.
The default value is `PolygonAlgorithms.default_atol = 1e-6`.
